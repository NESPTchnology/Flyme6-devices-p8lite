.class Lslim/provider/SlimSettings$NameValueCache;
...
.method static constructor <clinit>()V
    ...
    .line 269
    sput-object v0, Lslim/provider/SlimSettings$NameValueCache;->SELECT_VALUE:[Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lslim/provider/SlimSettings$NameValueCache;->mValues:Ljava/util/HashMap;

    .line 275
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lslim/provider/SlimSettings$NameValueCache;->mValuesVersion:J

    .line 278
    const/4 v0, 0x0

    iput-object v0, p0, Lslim/provider/SlimSettings$NameValueCache;->mContentProvider:Landroid/content/IContentProvider;

    .line 287
    iput-object p1, p0, Lslim/provider/SlimSettings$NameValueCache;->mVersionSystemProperty:Ljava/lang/String;

    .line 288
    iput-object p2, p0, Lslim/provider/SlimSettings$NameValueCache;->mUri:Landroid/net/Uri;

    .line 289
    iput-object p3, p0, Lslim/provider/SlimSettings$NameValueCache;->mCallGetCommand:Ljava/lang/String;

    .line 290
    iput-object p4, p0, Lslim/provider/SlimSettings$NameValueCache;->mCallSetCommand:Ljava/lang/String;
...
.method private lazyGetProvider(Landroid/content/ContentResolver;)Landroid/content/IContentProvider;
    ...
    .line 296
    :try_start_0
    iget-object v0, p0, Lslim/provider/SlimSettings$NameValueCache;->mContentProvider:Landroid/content/IContentProvider;
    ...
    .line 298
    iget-object v2, p0, Lslim/provider/SlimSettings$NameValueCache;->mUri:Landroid/net/Uri;
    ...
    iput-object v1, p0, Lslim/provider/SlimSettings$NameValueCache;->mContentProvider:Landroid/content/IContentProvider;
    :try_end_0
...
.method public getStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v5, v0, Lslim/provider/SlimSettings$NameValueCache;->mVersionSystemProperty:Ljava/lang/String;
    ...
    iget-wide v6, v0, Lslim/provider/SlimSettings$NameValueCache;->mValuesVersion:J
    ...
    iget-object v5, v0, Lslim/provider/SlimSettings$NameValueCache;->mValues:Ljava/util/HashMap;
    ...
    iput-wide v0, v2, Lslim/provider/SlimSettings$NameValueCache;->mValuesVersion:J
    ...
    .end local v18    # "newValuesVersion":J
    :cond_4
    invoke-direct/range {p0 .. p1}, Lslim/provider/SlimSettings$NameValueCache;->lazyGetProvider(Landroid/content/ContentResolver;)Landroid/content/IContentProvider;
    ...
    iget-object v5, v0, Lslim/provider/SlimSettings$NameValueCache;->mCallGetCommand:Ljava/lang/String;
    ...
    iget-object v6, v0, Lslim/provider/SlimSettings$NameValueCache;->mCallGetCommand:Ljava/lang/String;
    ...
    iget-object v6, v0, Lslim/provider/SlimSettings$NameValueCache;->mUri:Landroid/net/Uri;

    sget-object v7, Lslim/provider/SlimSettings$NameValueCache;->SELECT_VALUE:[Ljava/lang/String;
    ...
    iget-object v7, v0, Lslim/provider/SlimSettings$NameValueCache;->mUri:Landroid/net/Uri;
...
.method public putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    .line 310
    invoke-direct {p0, p1}, Lslim/provider/SlimSettings$NameValueCache;->lazyGetProvider(Landroid/content/ContentResolver;)Landroid/content/IContentProvider;
    ...
    iget-object v4, p0, Lslim/provider/SlimSettings$NameValueCache;->mCallSetCommand:Ljava/lang/String;
    ...
    iget-object v5, p0, Lslim/provider/SlimSettings$NameValueCache;->mUri:Landroid/net/Uri;

.class public Lslim/utils/AppHelper;
...
.method public static getFriendlyNameForUri(Landroid/content/Context;Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v1, v2}, Lslim/utils/AppHelper;->getFriendlyActivityName(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;Z)Ljava/lang/String;
    ...
    .line 113
    :cond_2
    invoke-static {p0, p1, v1}, Lslim/utils/AppHelper;->getFriendlyShortcutName(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Ljava/lang/String;
    :try_end_0
...
.method public static getFriendlyShortcutName(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, v2}, Lslim/utils/AppHelper;->getFriendlyActivityName(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;Z)Ljava/lang/String;
...
.method public static getProperSummary(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v7, "slim:array/"
    ...
    :cond_3
    invoke-static {p0, p1, p3}, Lslim/utils/AppHelper;->getFriendlyNameForUri(Landroid/content/Context;Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getShortcutPreferred(Landroid/content/Context;Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v1, v3}, Lslim/utils/AppHelper;->getFriendlyActivityName(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/Intent;Z)Ljava/lang/String;
    :try_end_0
    .catch Ljava/net/URISyntaxException; {:try_start_0 .. :try_end_0} :catch_0

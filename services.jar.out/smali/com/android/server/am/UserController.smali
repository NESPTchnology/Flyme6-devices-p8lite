...
.method private finishUserUnlockedCompleted(Lcom/android/server/am/UserState;)V
    ...
    :cond_1
    :try_start_2
    invoke-static/range {v20 .. v20}, Landroid/os/storage/StorageManager;->isUserKeyUnlocked(I)Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    iget-object v4, v0, Lcom/android/server/am/UserController;->mUserManager:Lcom/android/server/pm/UserManagerService;
    ...
    .line 404
    invoke-virtual/range {v43 .. v43}, Landroid/content/pm/UserInfo;->isInitialized()Z
    ...
    const-string/jumbo v6, "Initializing user #"
    ...
    .line 410
    new-instance v9, Lcom/android/server/am/UserController$2;

    move-object/from16 v0, p0

    move-object/from16 v1, v43

    invoke-direct {v9, v0, v1}, Lcom/android/server/am/UserController$2;-><init>(Lcom/android/server/am/UserController;Landroid/content/pm/UserInfo;)V
    ...
    const v5, #android:array@onbootboost_param_value#t

    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->getIntArray(I)[I

    move-result-object v40

    .local v40, "mBoostParamVal":[I
    ...
    .line 430
    .local v38, "lIsPerfBoostEnabled":Z
    :goto_0
    if-eqz v38, :cond_5
    ...
    const v5, #android:integer@onbootboost_duration#t

    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v39

    .local v39, "mBoostDuration":I
    new-instance v41, Landroid/util/BoostFramework;

    invoke-direct/range {v41 .. v41}, Landroid/util/BoostFramework;-><init>()V

    .local v41, "mPerf":Landroid/util/BoostFramework;
    sget-object v4, Lcom/android/server/am/UserController;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v6, "Bootup boost was triggered for "
    ...
    invoke-virtual {v0, v1, v2}, Landroid/util/BoostFramework;->perfLockAcquire(I[I)V

    .line 444
    .end local v39    # "mBoostDuration":I
    .end local v41    # "mPerf":Landroid/util/BoostFramework;
    :cond_5
    sget-object v4, Lcom/android/server/am/UserController;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v6, "Sending BOOT_COMPLETE user #"
    ...
    .line 454
    .local v24, "bootIntent":Landroid/content/Intent;
    ...
    .line 459
    sget v35, Lcom/android/server/am/ActivityManagerService;->MY_PID:I
    ...
    .line 457
    invoke-virtual/range {v21 .. v37}, Lcom/android/server/am/ActivityManagerService;->broadcastIntentLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;[Ljava/lang/String;ILandroid/os/Bundle;ZZIII)I
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    .line 428
    .end local v24    # "bootIntent":Landroid/content/Intent;
    .end local v38    # "lIsPerfBoostEnabled":Z
    :cond_7
    const/16 v38, 0x0
    ...
    .line 448
    .restart local v38    # "lIsPerfBoostEnabled":Z
    :cond_8
    :try_start_4
    invoke-static {}, Lcom/android/server/am/UserController;->isFirstBootOrUpgrade()Z
    ...
    .line 390
    .end local v38    # "lIsPerfBoostEnabled":Z
    .end local v40    # "mBoostParamVal":[I
    .end local v42    # "uptimeSeconds":I

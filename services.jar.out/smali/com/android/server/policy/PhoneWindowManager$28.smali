...
.method constructor <init>(Lcom/android/server/policy/PhoneWindowManager;IIILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/WindowManagerPolicy$WindowState;Z)V
    ...
    iput p2, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$visibility:I

    iput p3, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$fullscreenVisibility:I

    iput p4, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$dockedVisibility:I

    iput-object p5, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$fullscreenStackBounds:Landroid/graphics/Rect;

    iput-object p6, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$dockedStackBounds:Landroid/graphics/Rect;

    iput-object p7, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$win:Landroid/view/WindowManagerPolicy$WindowState;

    iput-boolean p8, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$needsMenu:Z
...
.method public run()V
    ...
    .line 9130
    iget v1, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$visibility:I

    iget v2, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$fullscreenVisibility:I

    .line 9131
    iget v3, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$dockedVisibility:I

    iget-object v5, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$fullscreenStackBounds:Landroid/graphics/Rect;

    .line 9132
    iget-object v6, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$dockedStackBounds:Landroid/graphics/Rect;

    iget-object v4, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$win:Landroid/view/WindowManagerPolicy$WindowState;
    ...
    .line 9133
    iget-boolean v1, p0, Lcom/android/server/policy/PhoneWindowManager$28;->val$needsMenu:Z

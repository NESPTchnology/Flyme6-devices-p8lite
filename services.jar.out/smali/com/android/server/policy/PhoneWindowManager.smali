...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-object v4, v0, Lcom/android/server/policy/PhoneWindowManager;->mHardwareKeyHandler:Lorg/slim/framework/internal/policy/HardwareKeyHandler;
    ...
    invoke-virtual/range {v4 .. v10}, Lorg/slim/framework/internal/policy/HardwareKeyHandler;->handleKeyEvent(IIZZZZ)Z
    ...
    .line 3305
    .restart local v35    # "isAlarmBoot":Z
    :cond_6
    const/16 v4, 0x52
    ...
    iget-wide v14, v0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotChordVolumeDownKeyTime:J

    .line 3317
    const-wide/16 v16, 0x96

    .line 3316
    add-long v50, v14, v16
    ...
    const-string/jumbo v11, "Ignoring HOME; event canceled."
    ...
    iget-object v11, v0, Lcom/android/server/policy/PhoneWindowManager;->mHomeDoubleTapTimeoutRunnable:Ljava/lang/Runnable;
    ...
    .line 3367
    invoke-virtual {v4, v11, v14, v15}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z
    ...
    .line 3383
    .restart local v22    # "attrs":Landroid/view/WindowManager$LayoutParams;
    ...
    .line 3454
    .end local v20    # "actionTriggered":Z
    ...
    iget-object v11, v0, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotRunnable:Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;
    ...
    invoke-direct {v0, v11, v4}, Lcom/android/server/policy/PhoneWindowManager;->launchAssistAction(Ljava/lang/String;I)V
    ...
    .line 3500
    .local v27, "dic":Landroid/os/IDeviceIdleController;
    if-eqz v27, :cond_31
    ...
    .line 3511
    .end local v27    # "dic":Landroid/os/IDeviceIdleController;
    .end local v55    # "voiceIntent":Landroid/content/Intent;
    :cond_32
    const/16 v4, 0x78
    ...
    invoke-virtual {v4, v11}, Lcom/android/server/policy/PhoneWindowManager$ScreenshotRunnable;->setScreenshotType(I)V
    ...
    .line 3529
    invoke-static {v4, v11, v13, v14}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    invoke-static {v4, v11, v0, v13}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    .line 3550
    new-instance v4, Landroid/content/Intent;

    const-string/jumbo v11, "android.intent.action.SHOW_BRIGHTNESS_DIALOG"
    ...
    invoke-direct {v0, v4, v11}, Lcom/android/server/policy/PhoneWindowManager;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V

    .line 3553
    .end local v23    # "auto":I
    .end local v24    # "brightness":I
    .end local v28    # "direction":I
    .end local v37    # "max":I
    .end local v40    # "min":I
    ...
    .line 3571
    .restart local v20    # "actionTriggered":Z
    :cond_3c
    invoke-virtual/range {p2 .. p2}, Landroid/view/KeyEvent;->getAction()I
    ...
    and-int/lit8 v21, v4, 0x32

    .line 3573
    .local v21, "altOnMask":I
    move-object/from16 v0, p0
    ...
    iget v11, v0, Lcom/android/server/policy/PhoneWindowManager;->mMetaState:I
    ...
    invoke-virtual {v4, v11}, Landroid/hardware/input/InputManagerInternal;->toggleCapsLock(I)V
    ...
    invoke-direct {v0, v4, v11}, Lcom/android/server/policy/PhoneWindowManager;->launchAssistAction(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v5}, Landroid/view/KeyCharacterMap;->isPrintingKey(I)Z
    ...
    invoke-virtual {v4, v0, v5, v1}, Lcom/android/server/policy/ShortcutManager;->getIntent(Landroid/view/KeyCharacterMap;II)Landroid/content/Intent;
    ...
    invoke-virtual {v4, v0, v5, v11}, Lcom/android/server/policy/ShortcutManager;->getIntent(Landroid/view/KeyCharacterMap;II)Landroid/content/Intent;
    ...
    const-string v13, "Dropping shortcut key combination because the activity to which it is registered was not found: META+"
    ...
    .local v25, "category":Ljava/lang/String;
    if-eqz v25, :cond_47
    ...
    invoke-direct {v0, v12, v4}, Lcom/android/server/policy/PhoneWindowManager;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    .end local v12    # "intent":Landroid/content/Intent;
    .end local v25    # "category":Ljava/lang/String;
    .end local v31    # "ex":Landroid/content/ActivityNotFoundException;
    :cond_4c
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/policy/PhoneWindowManager;->isUserSetupComplete()Z
    ...
    invoke-direct {v0, v4, v11}, Lcom/android/server/policy/PhoneWindowManager;->showRecentApps(ZZ)V
    ...
    invoke-direct {v0, v4, v11}, Lcom/android/server/policy/PhoneWindowManager;->hideRecentApps(ZZ)V
    ...
    invoke-virtual {v4, v11, v5, v0}, Lcom/android/server/policy/GlobalKeyManager;->handleGlobalKey(Landroid/content/Context;ILandroid/view/KeyEvent;)Z
    ...
    check-cast v48, Lcom/android/internal/policy/IShortcutService;

    .local v48, "shortcutService":Lcom/android/internal/policy/IShortcutService;
    if-eqz v48, :cond_59
    ...
    .end local v48    # "shortcutService":Lcom/android/internal/policy/IShortcutService;
    :cond_59
    move-object/from16 v0, p0
    ...
    const-string v11, "Could not dispatch event to device key handler"
    ...
    .end local v20    # "actionTriggered":Z
    .restart local v27    # "dic":Landroid/os/IDeviceIdleController;
    :catch_6
    move-exception v29
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    .restart local v12    # "isHomeWakeKey":Z
    goto :goto_4
    ...
    iput v15, v0, Lcom/android/server/policy/PhoneWindowManager;->mPendingWakeKey:I
    ...
    iget-object v0, v0, Lcom/android/server/policy/PhoneWindowManager;->mHardwareKeyHandler:Lorg/slim/framework/internal/policy/HardwareKeyHandler;
    ...
    invoke-virtual/range {v21 .. v21}, Lorg/slim/framework/internal/policy/HardwareKeyHandler;->isHwKeysDisabled()Z
    ...
    invoke-virtual/range {v21 .. v21}, Landroid/os/PowerManagerInternal;->setUserInactiveOverrideFromWindowManager()V
...
.method public setInitialDisplaySize(Landroid/view/Display;III)V
    ...
    const-string v8, "navigation_bar_can_move"
    ...
    invoke-static {v7, v8, v6, v9}, Lslim/provider/SlimSettings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string v7, "navigation_bar_show"

    const/4 v8, -0x2

    invoke-static {v6, v7, v5, v8}, Lslim/provider/SlimSettings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
...
.method public updateSettings()V
    ...
    const-string v10, "incall_back_button_behavior"
    ...
    iput v10, v0, Lcom/android/server/policy/PhoneWindowManager;->mIncallBackBehavior:I
    ...
    :cond_2
    const-string v12, "navigation_bar_can_move"
    ...
    invoke-static {v4, v12, v10, v13}, Lslim/provider/SlimSettings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v4, v10, v5, v12}, Lslim/provider/SlimSettings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    iget-object v10, v0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarHeightForRotationDefault:[I
    ...
    invoke-static/range {v13 .. v16}, Lslim/provider/SlimSettings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v13

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarHeightForRotationDefault:[I
    ...
    iget-object v10, v0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarWidthForRotationDefault:[I
    ...
    iget-object v14, v0, Lcom/android/server/policy/PhoneWindowManager;->mNavigationBarWidthForRotationDefault:[I
